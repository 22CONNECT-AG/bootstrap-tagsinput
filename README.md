# Bootstrap Tags Input [![Build Status](https://travis-ci.org/22CONNECT-AG/bootstrap-tagsinput.svg?branch=master)](https://travis-ci.org/bootstrap-tagsinput/bootstrap-tagsinput)
